...
<p>{{(__('registration.mailaccountcreatedforprojecttitle'))}}</p>
<p>{{(__('registration.mailaccountcreatedforprojectsection1'))}}</p>
<p class="token">{{(__('account.mail'))." : ".$email."     ".(__('account.password'))." : ".$password}}</p>
<p>{{(__('registration.mailaccountcreatedforprojectsection2))}}</p>
<br>
